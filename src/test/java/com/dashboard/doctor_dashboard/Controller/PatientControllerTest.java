...
class PatientControllerTest {
    ...
    void getMessageForReferredPatient() {
        ...
        ArrayList<String> newList = patientController.getMessageForReferredPatient(doctorId);
    ...
    void patientCategory() {
        ...
        ArrayList<String> newList = patientController.patientCategory(doctorId);
    ...
    void gender() {
        ...
        ArrayList<String> newList = patientController.gender(doctorId);
    ...
    void activePatient() {
        ...
        ArrayList<String> newList = patientController.activePatient(doctorId);
    ...
    void bloodGroup() {
        ...
        ArrayList<String> newList = patientController.bloodGroup(doctorId);
    ...
    void ageChart() {
        ...
        ArrayList<String> newList = patientController.ageChart(doctorId);
