...
class PrescriptionControllerTest {
    ...
    @Test
    void getAddPrescriptionTest() throws MessagingException, JSONException, IOException {
        final Long id =1L;
        ...
        Mockito.when(prescriptionService.addPrescription(Mockito.any(Long.class),Mockito.any(UpdatePrescriptionDto.class))).thenReturn(
                new ResponseEntity<>(new GenericMessage(Constants.SUCCESS,details), HttpStatus.OK));
